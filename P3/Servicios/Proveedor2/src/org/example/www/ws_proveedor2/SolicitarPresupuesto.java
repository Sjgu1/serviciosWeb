 ...
 */
            ...
            /**
            *  SolicitarPresupuesto bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SolicitarPresupuesto
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SolicitarPresupuesto",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SolicitarPresupuesto",
    ...
    public static class Factory{
        ...
        */
        public static SolicitarPresupuesto parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SolicitarPresupuesto object =
                new SolicitarPresupuesto();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SolicitarPresupuesto".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SolicitarPresupuesto)org.example.www.ws_proveedor2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
