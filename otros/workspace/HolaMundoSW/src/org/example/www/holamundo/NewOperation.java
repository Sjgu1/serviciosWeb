 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "http://www.example.org/HolaMundo/",
                "NewOperation",
                "ns1");
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://www.example.org/HolaMundo/");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NewOperation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "NewOperation",
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://www.example.org/HolaMundo/")){
                return "ns1";
            }
    ...
    public static class Factory{
        ...
        */
        public static NewOperation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NewOperation object =
                new NewOperation();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NewOperation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NewOperation)org.example.www.holamundo.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
